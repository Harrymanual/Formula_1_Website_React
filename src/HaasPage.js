...
import haasLogo from './images/haas.jpg';
...
const HaasPage = () => {
  ...
  useEffect(() => {
    fetch('/team_info.txt')
      ...
      .then(text => {
        const lines = text.split('\n').slice(100, 110); //red bull lines from txt file. hardocoding works fine for this as its just not worth it to spend that much time on something so trivial
        setInfoList(lines);
      })
